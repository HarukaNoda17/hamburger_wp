        ...
        <header class="l-header c-background-color--base">
            ...
            <div class="p-search--form">
                <form action="#" method="get" class="c-form-search">
                    ...
                    <input type="search" class="c-form-search__keyword c-img--magnifying-glass" placeholder="チーズバーガー">
        ...
        <main class="l-main">
            <article class="p-visual__archive">
                <section  class="p_visual__archive--main u-background--overlay--archive">
                    <h2 class="c-title--main c-title--under-text c-font-color--white c-font-family--robot c-font-weight--bold">Search:</h2>
                </section>
